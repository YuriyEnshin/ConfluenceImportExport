...
/// <summary>
/// Named-HTML-entity to code-point lookup shared by the content normalizers
/// (<see cref="XmlContentNormalizer"/>, <see cref="RegexContentNormalizer"/>):
/// entities that XML itself does not define (&amp;nbsp;, &amp;mdash;, ...) are
/// decoded to their characters before comparison and canonicalisation.
/// </summary>
